...
exports.runElementEditTest = function()
{
    ...
    function ProcessElements(reader, writer, visited) {
        var element, colorspace, redColor, blueColor, elementType, gs, form_obj, form_obj_num, insertedObj, new_writer;
        ...
        return regeneratorRuntime.wrap(function ProcessElements$(context$3$0) {
            ...
            case 17:
                ...
                context$3$0.next = (context$3$0.t0 === PDFNet.Element.Type.e_image ? 21 : (context$3$0.t0 === PDFNet.Element.Type.e_inline_image ? 21 : (context$3$0.t0 === PDFNet.Element.Type.e_path ? 22 : (context$3$0.t0 === PDFNet.Element.Type.e_text ? 29 : (context$3$0.t0 === PDFNet.Element.Type.e_form ? 36 : 55)))));
                break;
            case 21:
                return context$3$0.abrupt("break", 56);
            case 22:
                context$3$0.next = 24;
            ...
            case 39:
                ...
                if (!// if XObject not yet processed
                (visited.indexOf(form_obj_num) == -1)) {
                    context$3$0.next = 54;
                    break;
                }
            ...
            case 48:
                ...
                return context$3$0.delegateYield(ProcessElements(reader, new_writer, visited), "t1", 52);
            case 52:
                new_writer.end();
                reader.end();
            case 54:
    ...
    function main() {
        var ret, input_url, doc, writer, reader, visited, totalPageNumber, itr, page, currentPageNumber, sdfObj, insertedObj, docBuffer;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 18:
                totalPageNumber = context$3$0.sent;
                context$3$0.next = 21;
            ...
            case 31:
                currentPageNumber = context$3$0.sent;
            ...
            case 38:
                ...
                return context$3$0.delegateYield(ProcessElements(reader, writer, visited), "t0", 43);
            case 43:
                writer.end();
                reader.end();
            case 45:
