...
exports.runRectTest = function()
{
    ...
    function main() {
        var ret, input_path, doc, pg_itr1, media_box, docbuf;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 12:
                pg_itr1 = context$3$0.sent;
                context$3$0.next = 15;
                return pg_itr1.current();
            case 15:
                context$3$0.next = 17;
                return context$3$0.sent.getMediaBox();
            case 17:
                media_box = context$3$0.sent;
                // translate page 200 units left(1 uint = 1/72 inch)
                media_box.x1 -= 200;
                media_box.x2 -= 200;

                context$3$0.next = 22;
                return media_box.update();
            case 22:
                context$3$0.next = 24;
