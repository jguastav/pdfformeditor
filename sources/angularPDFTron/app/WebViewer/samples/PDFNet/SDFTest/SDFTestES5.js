...
exports.runSDFTest = function()
{
    ...
    function main() {
        var input_url, docorig, doc, trailer, itr, info, itrval, oldstr, custom_dict, custom_array, trailerRoot, embed_file, mystm, indStream, docbuf;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 5:
                docorig = context$3$0.sent;
                context$3$0.next = 8;
                return docorig.getSDFDoc();
            case 8:
            ...
            case 14:
                trailer = context$3$0.sent;
                context$3$0.next = 17;
                return trailer.find("Info");
            case 17:
            ...
            case 30:
                ...
                return itr.value();
            case 33:
                itrval = context$3$0.sent;
                context$3$0.next = 36;
                return itrval.getAsPDFText();
            case 36:
                oldstr = context$3$0.sent;
            ...
            case 48:
                context$3$0.next = 50;
                return info.putDict("My Direct Dict");
            case 50:
                custom_dict = context$3$0.sent;
            ...
            case 59:
                trailerRoot = context$3$0.sent;
                context$3$0.t0 = custom_array;
                context$3$0.next = 63;
                return trailerRoot.value();
            case 63:
                context$3$0.t1 = context$3$0.sent;
                context$3$0.t0.pushBack.call(context$3$0.t0, context$3$0.t1);
                context$3$0.next = 67;
            ...
            case 70:
                ...
                context$3$0.next = 73;
                return doc.createIndirectStreamFromFilter(mystm);
            case 73:
                indStream = context$3$0.sent;
                custom_array.pushBack(indStream);

                context$3$0.next = 77;
                return doc.saveMemory(0, "%PDF-1.4");
            case 77:
