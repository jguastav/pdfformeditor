...
exports.runElementReaderTest = function()
{
    ...
    function ProcessElements(reader) {
        var element, temp, data, operators, points;
        ...
        return regeneratorRuntime.wrap(function ProcessElements$(context$3$0) {
            ...
            case 6:
                ...
                context$3$0.next = (context$3$0.t0 === // Process path data...
                exports.PDFNet.Element.Type.e_path ? 10 : (context$3$0.t0 === // Process text strings...
                exports.PDFNet.Element.Type.e_text ? 16 : (context$3$0.t0 === // Process form XObjects
                exports.PDFNet.Element.Type.e_form ? 21 : 25)));
            ...
            case 21:
                reader.formBegin();
                return context$3$0.delegateYield(ProcessElements(reader), "t1", 23);
            case 23:
                reader.end();
                return context$3$0.abrupt("break", 25);
            case 25:
    ...
    function main() {
        var ret, input_url, doc, pgnum, page_reader, itr, curritr;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 0:
                ...
                input_url = "../TestFiles/";
                context$3$0.next = 5;
                return exports.PDFNet.PDFDoc.createFromURL(input_url + "newsletter.pdf");
            case 5:
            ...
            case 11:
                pgnum = context$3$0.sent;
                context$3$0.next = 14;
                return exports.PDFNet.ElementReader.create();
            case 14:
            ...
            case 24:
                ...
                return context$3$0.delegateYield(ProcessElements(page_reader), "t0", 27);
            case 27:
                page_reader.end();
            case 28:
                //  Read every page
