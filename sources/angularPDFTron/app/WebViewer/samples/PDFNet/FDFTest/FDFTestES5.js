...
exports.runFDFTest = function()
{
    ...
    function main() {
        var input_url, fdf_doc, doc, pitr, page, i, annot_obj, docbuf;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 0:
                ...
                context$3$0.next = 6;
                return createFDFFromXFDFURL(input_url + "form1_annots.xfdf");
            case 6:
                fdf_doc = context$3$0.sent;
                context$3$0.next = 9;
                return PDFNet.PDFDoc.createFromURL(input_url + "form1.pdf");
            case 9:
            ...
            case 28:
                annot_obj = context$3$0.sent;
                context$3$0.next = 31;
                return annot_obj.getType();
            case 31:
                context$3$0.t0 = context$3$0.sent;
                context$3$0.next = (context$3$0.t0 === PDFNet.Annot.Type.e_Widget ? 34 : (context$3$0.t0 === PDFNet.Annot.Type.e_Link ? 34 : (context$3$0.t0 === PDFNet.Annot.Type.e_Sound ? 34 : (context$3$0.t0 === PDFNet.Annot.Type.e_Movie ? 34 : (context$3$0.t0 === PDFNet.Annot.Type.e_FileAttachment ? 34 : 35)))));
                break;
            case 34:
            ...
            case 41:
                context$3$0.prev = 41;
                context$3$0.t1 = context$3$0["catch"](18);
                console.log("Error Removing Annotations: " + context$3$0.t1);
                context$3$0.next = 46;
                return page.getSDFObj();
            case 46:
                context$3$0.sent.erase("Annots");
            case 47:
                pitr.next();
                context$3$0.next = 15;
                break;
