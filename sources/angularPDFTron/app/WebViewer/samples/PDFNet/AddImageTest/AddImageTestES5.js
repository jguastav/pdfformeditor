...
exports.runAddImageTest = function()
{
    ...
    function main() {
        var input_url, doc, builder, writer, pageRect, page, img, matrix, matrix2, element, hint_set, enc, timesFont, element2, docbuf;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 24:
                ...
                context$3$0.next = 27;
                return PDFNet.Matrix2D.create(200, 0, 0, 250, 50, 500);
            case 27:
                matrix = context$3$0.sent;
                context$3$0.next = 30;
                return PDFNet.Matrix2D.createZeroMatrix();
            case 30:
                matrix2 = context$3$0.sent;
                context$3$0.next = 33;
                return matrix2.set(200, 0, 0, 250, 50, 500);
            case 33:
                context$3$0.next = 35;
                return builder.createImageFromMatrix(img, matrix2);
            case 35:
                element = context$3$0.sent;
                writer.writePlacedElement(element);

                context$3$0.next = 39;
                return PDFNet.Image.createFromURL(doc, input_url + "butterfly.png");
            case 39:
                img = context$3$0.sent;
                context$3$0.t0 = PDFNet.Matrix2D;
                context$3$0.next = 43;
            ...
            case 46:
                ...
                context$3$0.next = 49;
                return context$3$0.t0.create.call(context$3$0.t0, context$3$0.t1, 0, 0, context$3$0.t2, 300, 500);
            case 49:
                matrix = context$3$0.sent;
                context$3$0.next = 52;
            ...
            case 52:
                ...
                context$3$0.next = 56;
                return PDFNet.Image.createFromURL(doc, input_url + "pdfnet.gif");
            case 56:
                img = context$3$0.sent;
                context$3$0.t3 = PDFNet.Matrix2D;
                context$3$0.next = 60;
                return img.getImageWidth();
            case 60:
            ...
            case 63:
                ...
                context$3$0.next = 66;
                return context$3$0.t3.create.call(context$3$0.t3, context$3$0.t4, 0, 0, context$3$0.t5, 50, 350);
            case 66:
                matrix = context$3$0.sent;
                context$3$0.next = 69;
                return builder.createImageFromMatrix(img, matrix);
            case 69:
                ...
                context$3$0.next = 73;
                return PDFNet.Image.createFromURL(doc, input_url + "grayscale.tif");
            case 73:
                img = context$3$0.sent;
                context$3$0.t6 = PDFNet.Matrix2D;
                context$3$0.next = 77;
                return img.getImageWidth();
            case 77:
            ...
            case 80:
                ...
                context$3$0.next = 83;
                return context$3$0.t6.create.call(context$3$0.t6, context$3$0.t7, 0, 0, context$3$0.t8, 10, 50);
            case 83:
                matrix = context$3$0.sent;
                context$3$0.next = 86;
                return builder.createImageFromMatrix(img, matrix);
            ...
            case 92:
                ...
                context$3$0.next = 96;
                return PDFNet.ObjSet.create();
            case 96:
                hint_set = context$3$0.sent;
                context$3$0.next = 99;
                return hint_set.createArray();
            case 99:
                enc = context$3$0.sent;
                context$3$0.next = 102;
                return enc.pushBackName("JBIG2");
            case 102:
                context$3$0.next = 104;
                return enc.pushBackName("Lossy");
            case 104:
                context$3$0.next = 106;
                return PDFNet.Image.createFromURL(doc, input_url + "multipage.tif", enc);
            case 106:
                img = context$3$0.sent;
                context$3$0.next = 109;
                return PDFNet.Matrix2D.create(612, 0, 0, 794, 0, 0);
            case 109:
                matrix = context$3$0.sent;
            ...
            case 118:
                ...
                return PDFNet.Image.createFromURL(doc, input_url + "palm.jp2");
            case 122:
                img = context$3$0.sent;
                context$3$0.t9 = PDFNet.Matrix2D;
            ...
            case 129:
                ...
                return context$3$0.t9.create.call(context$3$0.t9, context$3$0.t10, 0, 0, context$3$0.t11, 96, 80);
            case 132:
                matrix = context$3$0.sent;
            ...
            case 139:
                ...
                context$3$0.t12 = writer;
                context$3$0.next = 143;
                return builder.createTextBeginWithFont(timesFont, 32);
            case 143:
                context$3$0.t13 = context$3$0.sent;
                context$3$0.t12.writeElement.call(context$3$0.t12, context$3$0.t13);
                context$3$0.next = 147;
                return builder.createTextRun("JPEG2000 Sample", timesFont, 32);
            case 147:
                element = context$3$0.sent;
                context$3$0.next = 150;
                return PDFNet.Matrix2D.create(1, 0, 0, 1, 190, 30);
            case 150:
                matrix = context$3$0.sent;
                // yield?
            ...
            case 161:
                ...
                break;
            case 166:
                context$3$0.prev = 166;
                context$3$0.t14 = context$3$0["catch"](0);
                console.log(context$3$0.t14);
            case 169:
            case "end":
                return context$3$0.stop();
            }
        }, marked2$0[0], this, [[0, 166]]);
    }
