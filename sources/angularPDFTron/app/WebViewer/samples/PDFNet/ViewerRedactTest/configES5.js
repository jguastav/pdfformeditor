...
(function() {
    ...
    var CustomRedactionCreateTool = function(docViewer, pdfDoc) {
    ...
    CustomRedactionCreateTool.prototype.mouseLeftUp = function(e) {
        ...
        if(annot){
            ...
            var displayModeManager = readerControl.docViewer.getDisplayModeManager();
    ...
    $(document).on("documentLoaded", function(event) {
        $('#overflowToolsContainer').prepend('<span data-toolmode="AnnotationCreateRedactionTool" class="annotTool glyphicons" title="Redaction"><img src="../../samples/custom-annotations/annot_custom_redact.png"/></span>');
    ...
    var redactElementsInBox = function(pdfDoc, docCore, annot, annotManager){
        ...
        function main() {
            var ret, islocked, pageNumber, doc, redactRectX1, redactRectY1, redactRectX2, redactRectY2, listOfAnnots, i, currAnnot, currAnnotPage, currAnnotX1, currAnnotX2, currAnnotY1, currAnnotY2, pdfCoord, pdfCoord2, redactionArray, appear;
            ...
            return regeneratorRuntime.wrap(function main$(context$3$0) {
                ...
                case 0:
                    ...
                    redactRectX1 = annot.getX();
                    redactRectY1 = annot.getY();
                    redactRectX2 = redactRectX1+annot.getWidth();
                    redactRectY2 = redactRectY1+annot.getHeight();
                    listOfAnnots = annotManager.getAnnotationsList();
                    i = listOfAnnots.length-1;
                case 14:
                    if (!(i >= 0)) {
                        context$3$0.next = 31;
                        break;
                    ...
                    currAnnot = listOfAnnots[i];
                    currAnnotPage = currAnnot.PageNumber;
                    ...
                    return context$3$0.abrupt("continue", 28);
                case 19:
                    currAnnotX1 = currAnnot.X;
                    currAnnotX2 = currAnnot.X + currAnnot.Width;
                    ...
                    return context$3$0.abrupt("continue", 28);
                case 23:
                    currAnnotY1 = currAnnot.Y;
                    currAnnotY2 = currAnnot.Y + currAnnot.Height;
                ...
                case 28:
                    ...
                    break;
                case 31:
                    pdfCoord = docCore.getPDFCoordinates(pageNumber-1, redactRectX1, redactRectY1);
                    pdfCoord2 = docCore.getPDFCoordinates(pageNumber-1, redactRectX2, redactRectY2);
                    redactionArray = [];
                    context$3$0.t0 = redactionArray;
                    context$3$0.t1 = PDFNet.Redactor;
                    context$3$0.t2 = pageNumber;
                    context$3$0.next = 39;
                    return PDFNet.Rect.init(pdfCoord.x, pdfCoord.y, pdfCoord2.x, pdfCoord2.y);
                case 39:
                    context$3$0.t3 = context$3$0.sent;
                    context$3$0.next = 42;
                    return context$3$0.t1.RedactionCreate.call(context$3$0.t1, context$3$0.t2, context$3$0.t3, false, "");
                case 42:
                    context$3$0.t4 = context$3$0.sent;
                    context$3$0.t0.push.call(context$3$0.t0, context$3$0.t4);
                    appear = {};
                    context$3$0.next = 47;
                    return PDFNet.Redactor.redact(doc, redactionArray, appear, false, false);
                case 47:
