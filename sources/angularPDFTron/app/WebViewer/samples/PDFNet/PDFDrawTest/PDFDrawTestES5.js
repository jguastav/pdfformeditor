...
exports.runPDFDrawTest = function()
{
    ...
    function main() {
        var ret, input_url, doc, pdfdraw, itr, currPage, pngBuffer, tifBuffer;
        ...
        return regeneratorRuntime.wrap(function main$(context$3$0) {
            ...
            case 5:
                ...
                context$3$0.next = 11;
                return exports.PDFNet.PDFDraw.create(92);
            case 11:
            ...
            case 17:
                ...
                context$3$0.next = 20;
                return pdfdraw.exportStream(currPage, "PNG");
            case 20:
                pngBuffer = context$3$0.sent;
                saveBufferAsPNG(pngBuffer, "newsletter.png");
                context$3$0.next = 24;
                return pdfdraw.exportStream(currPage, "TIFF");
            case 24:
                tifBuffer = context$3$0.sent;
