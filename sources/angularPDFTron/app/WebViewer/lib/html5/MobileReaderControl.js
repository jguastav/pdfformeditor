...
(function(exports) {
    ...
    exports.ReaderControl = function(options) {
        ...
        if (_.isUndefined(window.devicePixelRatio) && exports.utils.ie && window.innerWidth < 1024) {
        ...
        if (!window.opera && !me.androidBrowser && !exports.utils.ieWebView && !uiWebView) {
    ...
    exports.ReaderControl.prototype = {
        ...
        bindEvents: function() {
            ...
            $('#annotListButton').on('click', function() {
                showAnnotations();
            });
