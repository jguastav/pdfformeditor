...
var recursive = '/**/*.*';
var input = 'lib/html5';
var output = 'lib/html5-min';

// paths to input files
var paths = {
    externalScripts: [input + '/external/jquery-2.1.0.min.js', input + '/external/jquery-ui/jquery-ui-1.11.1.custom.min.js', input + '/external/jquery.treeview.js',
        input + '/external/jquery.mousewheel.js', input + '/external/jquery.flexibleArea.js', input + '/external/moment.min.js', 
        input + '/external/modernizr.custom.js', input + '/external/drop/drop.min.js', input + '/external/Autolinker.min.js', input + '/external/context.js'],

    mobileExternalScripts: [input + '/external/jquery-2.1.0.min.js', input + '/mobileSetup.js', input + '/external/jquery.mobile/jquery.mobile-1.4.4.min.js', 
        input + 'external/jquery.doubletap.js', input + '/external/fastclick.js', input + '/external/touchr.js', input + '/external/modernizr.custom.js'],
    ...
    mobileViewerCSS: [input + '/MobileReaderControl.css', input + '/external/jquery.mobile/jquery.mobile-1.4.4.min.css'],
...
gulp.task('update-tags-html', function() {
    return gulp.src(paths.readerControlHTML)
        .pipe(htmlReplace({
            'icons-css': outputs.iconsCSSPath + '/' + outputs.iconsCSS,
            'viewer-css': outputs.viewerCSSPath + '/' + outputs.viewerCSS,
            'external-js': outputs.externaljsPath + '/' + outputs.externaljs,
            'readercontrol-js': outputs.readerControljsPath + '/' + outputs.readerControljs
        }, {
            keepUnassigned: true
        }))
        .pipe(minifyHTML())
...
gulp.task('mobile-update-tags-html', function() {
    return gulp.src(paths.mobileReaderControlHTML)
        .pipe(htmlReplace({
            'icons-css': outputs.iconsCSSPath + '/' + outputs.iconsCSS,
            'viewer-css': outputs.mobileViewerCSSPath + '/' + outputs.mobileViewerCSS,
            'external-js': outputs.mobileExternaljsPath + '/' + outputs.mobileExternaljs,
            'readercontrol-js': outputs.mobileReaderControljsPath + '/' + outputs.mobileReaderControljs
        }, {
            keepUnassigned: true
        }))
        .pipe(minifyHTML())
